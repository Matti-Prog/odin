...
class DenoiserTransformerNoLocal(nn.Module):
    ...
    def forward(self, points, global_feat, point_feat, t): # point_feat is dummy for keeping signature consistent
        point_feat = None # to guarantee that this model does not use local features
