...
class SHREC19PointCloudDataset(Dataset):
    """
    Folder structure:
    ...
    def _make_dataset(self):
        ...
        for scan_path in scan_files:
            ...
            samples.append({"name": name, "scan_path": scan_path})
        return samples
    ...
    def save_sample(self, *, sample: dict, output_dir: str):
        ...
        if ("pred_pc" in sample) and ("scan_pc" in sample):
